        ...
        <nav className="border-b border-white/5 bg-ds-bg/80 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6 text-sm">
              <a href="/library" className="text-white/50 hover:text-white transition-colors">Library</a>
              <a href="/kb" className="text-white/50 hover:text-white transition-colors">Slang KB</a>
